...
from qm_code_runner.images import build_runtime_images, configure_images
from qm_code_runner.execution import get_docker_client
...
def client(monkeypatch: pytest.MonkeyPatch) -> TestClient:
    ...
    from qm_code_runner.app import app
