...
from qm_code_runner.execution import (
    cleanup_orphaned_containers,
    execute_code_in_container,
    get_docker_client,
)
from qm_code_runner.images import (
    cleanup_prebuilds,
    configure_images,
    ensure_prebuilt_image,
    router as images_router,
)
from qm_code_runner.schemas import CodeExecutionRequest, CodeExecutionResponse
from qm_code_runner.security import configure_auth, verify_auth
...
def list_runtimes() -> dict[str, Any]:
    ...
    from qm_code_runner.images import list_images
