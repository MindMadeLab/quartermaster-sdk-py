...
from qm_providers.exceptions import ProviderError
...
class TestGroqProvider:
    ...
    def test_init(self):
        from qm_providers.providers.groq import GROQ_BASE_URL
...
class TestXAIProvider:
    ...
    def test_init(self):
        from qm_providers.providers.xai import XAI_BASE_URL
