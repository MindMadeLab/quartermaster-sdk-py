# quartermaster-providers — Extraction TODO
...
- [x] PyPI package: `quartermaster-providers` or `quartermaster-providers`
- [x] Optional dependencies: `pip install quartermaster-providers[openai]`, `quartermaster-providers[anthropic]`, `quartermaster-providers[google]`, `quartermaster-providers[all]`
