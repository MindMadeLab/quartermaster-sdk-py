...
When quartermaster-nodes is available, this can be replaced with imports from that package.
"""
...
class NodeExecutor(Protocol):
    ...
    (from quartermaster-nodes). The engine calls `execute()` and receives a `NodeResult`.
    """
