...
```bash
pip install qm-engine[sqlite]   # SQLite-backed persistent store
pip install qm-engine[redis]    # Redis-backed high-performance store
pip install qm-engine[all]      # All optional dependencies
```
