...
This is the heart of qm-engine. It takes a graph definition, resolves node
...
from qm_engine.nodes import NodeExecutor, NodeRegistry, NodeResult
...
from qm_engine.traversal.traverse_out import TraverseOutGate
