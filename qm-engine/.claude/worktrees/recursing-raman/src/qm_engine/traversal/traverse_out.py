...
from qm_engine.nodes import NodeResult
from qm_engine.types import AgentVersion, GraphNode, TraverseOut
...
class TraverseOutGate:
    ...
    def _spawn_all(self, node_id: UUID, graph: AgentVersion) -> list[GraphNode]:
    ...
    def _spawn_picked(
        self, node_id: UUID, graph: AgentVersion, result: NodeResult
    ) -> list[GraphNode]:
    ...
    def _spawn_start(self, graph: AgentVersion) -> list[GraphNode]:
