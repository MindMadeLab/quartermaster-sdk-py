...
from qm_nodes.enums import AvailableThoughtTypes, AvailableTraversingOut
...
class TestAgentNode:
    ...
    def test_flow_config(self):
        from qm_nodes.nodes.llm.agent import AgentNodeV1
        from qm_nodes.enums import AvailableErrorHandlingStrategies
...
class TestMergeNode:
    ...
    def test_flow_config_await_all(self):
        from qm_nodes.nodes.llm.merge import Merge1
        from qm_nodes.enums import AvailableTraversingIn
