"""Tests for qm_tools.registry — ToolRegistry, register_tool, JSON Schema export."""
...
from qm_tools.registry import _tool_to_json_schema, _param_to_json_schema
...
class TestRegisterToolDecorator:
    def test_register_tool_decorator(self):
        ...
        import qm_tools.registry as reg_module
