...
class TestDecisionInsideBranch:
    ...
    def test_decision_three_options_inside_branch(self):
        ...
        graph = (
            ...
            .parallel()
            .branch()
            .instruction("Fast track")
            .end()
            .branch()
            .decision("Triage", options=["low", "medium", "high"])
            .on("low")
            .instruction("Low handler")
            .end()
            .on("medium")
            .instruction("Medium handler")
            .end()
            .on("high")
            .instruction("High handler")
            .end()
            .merge("Triage merge")
            .end()
            .merge("Fan-in")
...
class TestDeepNesting:
    def test_three_levels_deep(self):
        ...
        graph = (
            ...
            .end()
            .branch()
            .instruction("Level 3b")
            .end()
            .merge("L3 merge")
            .end()
            .branch()
            .instruction("Level 2b")
            .end()
            .merge("L2 merge")
            .end()
            .branch()
            .instruction("Level 1b")
            .end()
            .merge("L1 merge")
            .end()
            .build()
...
class TestEdgeLabelsInNestedBranches:
    ...
    def test_decision_labels_nested_in_parallel(self):
        ...
        graph = (
            ...
            .on("alpha")
            .instruction("Alpha handler")
            .end()
            .on("beta")
            .instruction("Beta handler")
            .end()
            .merge("D merge")
            .end()
            .branch()
...
class TestConvergenceInNestedBranches:
    ...
    def test_if_branches_converge_in_parallel_branch(self):
        ...
        source_names = sorted(
            ...
            if False
            else [n for n in graph.nodes if n.id == e.source_id][0].name
            for e in edges_in
        )
