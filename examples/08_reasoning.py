...
agent = (
    ...
    .reasoning("Deep analysis", model="claude-haiku-4-5-20251001")
    .instruction("Gather evidence", model="claude-haiku-4-5-20251001", system_instruction="List key facts and sources")
    .reasoning("Evaluate evidence", model="claude-haiku-4-5-20251001")
    .summarize("Executive summary", model="claude-haiku-4-5-20251001", system_instruction="Create a concise executive summary")
    .end()
)
